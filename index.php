<?php 
 ...
 $conn = connect();
 $sql ="SELECT p.title,p.feature,p.created,p.content,p.views,p.likes,c.`name`,u.nickname,(SELECT count(id) FROM comments WHERE post_id = p.id) as commentsCount FROM posts p
      ...
      <div class="panel new">
        ...
        <?php 
            foreach ($postArr as $key => $value) { ?>
                ...
                <div class="main">
                    <p class="info"><?=$value["nickname"] ?> 发表于 <?php echo $value["created"] ?></p>
